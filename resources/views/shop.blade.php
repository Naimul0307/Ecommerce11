    ...
    <section class="shop-main container d-flex pt-4 pt-xl-5">
      ...
      <div class="shop-list flex-grow-1">
                            ...
                            <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        ...
                                        <a href="details.html"><img loading="lazy" src="{{ asset('uploads/products')}}/{{ $product->image }}" width="330" height="400" alt="{{ $product->image_alt_text }}" class="pc__img"></a>
                                        @else
                                        <a href="details.html"><img loading="lazy" src="{{ asset('uploads/placeholder.jpg') }}" width="330" height="400" alt="{{ $product->image_alt_text }}" class="pc__img"></a>
                                        @endif
                                    </div>
                                    <div class="swiper-slide">
                                        @if (!empty($product->images))
                                        @foreach (explode(",",$product->images) as $img)
                                        <a href="details.html"><img loading="lazy" src="{{ asset('uploads/product-gallery')}}/{{ $img }}" width="330" height="400" alt="{{ $product->image_alt_text }}" class="pc__img"></a>
                                        @endforeach
                                        @else
                                        <a href="details.html"><img loading="lazy" src="{{ asset('uploads/placeholder.jpg') }}" width="330" height="400" alt="{{ $product->image_alt_text }}" class="pc__img"></a>
                                        @endif
                            ...
                            <div class="product-card__price d-flex">
                                <span class="money price">
                                    @if (!empty($product->sale_price))
                                        <span class="text-decoration-line-through text-secondary me-1">${{ $product->regular_price }}</span>
        ...
        <div class="flex items-center justify-between flex-wrap gap10 wgp-pagination">
            {{ $products->links('paginatios.defult') }}
        </div>
      </div>
    </section>
  </main>
