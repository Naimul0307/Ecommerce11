            ...
            <div class="wg-box">
                    ...
                    <div class="upload-image flex-grow">
                        <div class="item" id="imgpreview">
                            ...
                            <img src="{{ asset('uploads/products/thumbnail')}}/{{ $product->image }}"
                                class="effect8" alt="{{ $product->image_alt_text }}">
                            @else
                ...
                <fieldset>
                    ...
                    <div class="upload-image mb-16">
                        ...
                        <div class="item">
                            <img src="{{ asset('uploads/product-gallery/thumbnail')}}/{{ trim($img) }}" alt="{{ $product->image_alt_text }}">
                        </div>
                        @endforeach
                        @else
                        <div class="item">
                            <img src="{{ asset('uploads/placeholder.jpg') }}" alt="{{ $product->image_alt_text }}">
                        </div>
                        @endif
                    ...
                    <fieldset class="name">
                        ...
                        <div class="select mb-10">
                            <select class="" name="stock_status">
                                ...
                                <option value="preorder" {{ $product->stock_status == "preorder" ? "selected" : "" }}>Preorder</option>
                            </select>
                        </div>
                    </fieldset>
                    @error('stock_status')
